      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="flex flex-wrap justify-center gap-10 lg:gap-16">
          ...
          <div className="flex-shrink-0 relative group">
            ...
            >
              <img
                src="https://media.discordapp.net/attachments/1364759010611298324/1411863654869110804/staralliance.png?ex=68b633fe&is=68b4e27e&hm=bd3dfb4b90bb9d323d5955913a2301c9222045f61600592eb7a04b57e0b29af8&=&format=webp&quality=lossless&width=281&height=281"
                alt="Star Alliance"
          ...
          <div className="flex-shrink-0 relative group">
            ...
            >
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Lufthansa_Logo.svg/1200px-Lufthansa_Logo.svg.png"
                alt="Lufthansa"
                className="h-14 object-contain filter drop-shadow-md brightness-0 invert opacity-80 group-hover:opacity-100 transition-opacity duration-300"
              />
              <div className="absolute left-1/2 -top-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-3 opacity-0 group-hover:opacity-100 transition-all duration-300 bg-gray-900 text-white text-sm py-1 px-3 rounded-md whitespace-nowrap pointer-events-none z-20">
          ...
          <div className="flex-shrink-0 relative group">
            ...
            >
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Eurowings_logo.svg/1200px-Eurowings_logo.svg.png"
                alt="Eurowings"
                className="h-14 object-contain filter drop-shadow-md brightness-0 invert opacity-80 group-hover:opacity-100 transition-opacity duration-300"
              />
              <div className="absolute left-1/2 -top-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-3 opacity-0 group-hover:opacity-100 transition-all duration-300 bg-gray-900 text-white text-sm py-1 px-3 rounded-md whitespace-nowrap pointer-events-none z-20">
